 ...
 public:
  ...
  void runOnOperation() override {
    ...
    getOperation().walk([&](mlir::Operation* op) {
      ...
      // TODO(He Jia): Remove unspecified locations when a global flag is set.
    });
  }

  void ExtractXlaMlirDebuginfo(
    mlir::Location loc, llvm::SmallVector<std::string>& debuginfos) {
    ...
    // TODO(He Jia): Handle other loc types if debuginfo can be
    // propagated/nested in other loc type.
  }
