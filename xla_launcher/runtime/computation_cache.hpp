...
#ifndef XLA_LAUNCHER_RUNTIME_COMPILATION_CACHE_HPP_
#define XLA_LAUNCHER_RUNTIME_COMPILATION_CACHE_HPP_
...
class Cache : public AbstractCache<K, T, H, E> {
 ...
 private:
  ...
  using ElementMap = std::unordered_map<
    const K*, typename ElementList::iterator, Hasher, Equaler>;
